...
nextStepFile: "[File references (ONLY variables used in this step)](./step-v-12-completeness-validation.md)"
...
Assess the PRD as a cohesive, compelling document - evaluating document flow, dual audience effectiveness (humans and LLMs), Synapse PRD principles compliance, and overall quality rating.
...
- 🎯 Evaluate document flow, dual audience, Synapse principles
...
Invoke the `synapse-advanced-elicitation` skill
...
**3. Synapse PRD Principles Compliance:**
...
- Check Synapse principles compliance
...
### Synapse PRD Principles Compliance
...
- Synapse PRD principles compliance checked
...
- Not checking all Synapse principles
