...
- IF A: Invoke the `synapse-advanced-elicitation` skill, and when finished redisplay the menu
- IF P: Invoke the `synapse-party-mode` skill, and when finished redisplay the menu
- IF C: Save content to {outputFile}, update frontmatter, then read fully and follow: [Step 6: Innovation Discovery](./step-06-innovation.md)
...
ONLY WHEN [C continue option] is selected and [content saved or skipped], will you then read fully and follow: [Step 6: Innovation Discovery](./step-06-innovation.md) to explore innovation.
