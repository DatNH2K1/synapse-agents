...
2. Analyze against Synapse standards (from prd-purpose.md)
...
Read fully and follow: [File references (ONLY variables used in this step)](./step-e-03-edit.md)
...
- IF A: Invoke the `synapse-advanced-elicitation` skill, then return to discussion
- IF P: Invoke the `synapse-party-mode` skill, then return to discussion
