...
- Format: {Synapse Standard / Synapse Variant / Legacy (converted)}
...
- **IF V (Run Full Validation):**
  ...
  - Invoke the `synapse-product-suite` skill to run the complete validation workflow

- **IF E (Edit More):**
  - Display: "**Additional Edits**"
  - Ask: "What additional edits would you like to make?"
  - Accept input, then display: "**Returning to edit step...**"
  - Read fully and follow: [File references (ONLY variables used in this step)](./step-e-03-edit.md) again
