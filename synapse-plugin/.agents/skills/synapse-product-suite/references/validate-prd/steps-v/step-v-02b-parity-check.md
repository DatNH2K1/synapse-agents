...
Analyze non-standard PRD and identify gaps to achieve Synapse PRD parity, presenting user with options for how to proceed.
...
- ✅ You bring Synapse PRD standards expertise and gap analysis
...
- 🎯 Analyze each Synapse PRD section for gaps
...
### 1. Analyze Each Synapse PRD Section

For each of the 6 Synapse PRD core sections, analyze:
...
**Overall Effort to Reach Synapse Standard:** [Quick/Moderate/Substantial]
...
Your PRD is missing {count} of 6 core Synapse PRD sections. The overall effort to reach Synapse standard is: **{effort level}**
...
- All 6 Synapse PRD sections analyzed for gaps
