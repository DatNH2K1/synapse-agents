...
- Example: If `stepsCompleted: [1, 2, 3]`, load [Step 4: Core Architectural Decisions](./step-04-decisions.md)
...
- If confirmed: Delete existing document and read fully and follow: [Step 1: Architecture Workflow Initialization](./step-01-init.md)
...
- [Step 2: Project Context Analysis](./step-02-context.md)
...
- [Step 7: Architecture Validation & Completion](./step-07-validation.md)
- [Step 8: Architecture Completion & Handoff](./step-08-complete.md)
