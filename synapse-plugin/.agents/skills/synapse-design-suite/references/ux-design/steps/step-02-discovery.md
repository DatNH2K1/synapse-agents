...
- Load [Step 3: Core Experience Definition](./step-03-core-experience.md)

## APPEND TO DOCUMENT:

When user selects 'C', append the content directly to the document. Only after the content is saved to document, read fully and follow: [Step 3: Core Experience Definition](./step-03-core-experience.md).
