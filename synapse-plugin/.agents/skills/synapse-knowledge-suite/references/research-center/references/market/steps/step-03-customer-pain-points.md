...
- Load: [Market Research Step 4: Customer Decisions and Journey](./step-04-customer-decisions.md)
...
After user selects 'C', load [Market Research Step 4: Customer Decisions and Journey](./step-04-customer-decisions.md) to analyze customer decision processes, journey mapping, and decision factors for {{research_topic}}.
