...
- Invoke the `synapse-advanced-elicitation` skill with current project structure
...
- Invoke the `synapse-party-mode` skill with project structure context
...
- Load [Step 7: Architecture Validation & Completion](./step-07-validation.md)
...
After user selects 'C' and content is saved to document, load [Step 7: Architecture Validation & Completion](./step-07-validation.md) to validate architectural coherence and completeness.
