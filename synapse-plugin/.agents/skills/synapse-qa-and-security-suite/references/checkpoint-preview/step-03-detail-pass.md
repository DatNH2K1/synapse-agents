...
- If they want to **approve and ship** → read fully and follow [Step 5: Wrap-Up](./step-05-wrapup.md)
- If they want to **reject and rework** → read fully and follow [Step 5: Wrap-Up](./step-05-wrapup.md)
...
Read fully and follow [Step 4: Testing](./step-04-testing.md)
