...
- Invoke the `synapse-advanced-elicitation` skill with the current responsive/accessibility content
...
- Invoke the `synapse-party-mode` skill with the current responsive/accessibility strategy
...
- Load [Step 14: Workflow Completion](./step-14-complete.md)
...
After user selects 'C' and content is saved to document, load [Step 14: Workflow Completion](./step-14-complete.md) to finalize the UX design workflow.
