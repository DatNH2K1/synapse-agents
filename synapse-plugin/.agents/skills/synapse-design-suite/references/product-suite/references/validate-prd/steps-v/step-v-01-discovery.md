...
nextStepFile: "[File references (ONLY variables used in this step)](./step-v-02-format-detection.md)"
...
This file contains the Synapse PRD philosophy, standards, and validation criteria that will guide all validation checks. Internalize this understanding - it defines what makes a great Synapse PRD.
