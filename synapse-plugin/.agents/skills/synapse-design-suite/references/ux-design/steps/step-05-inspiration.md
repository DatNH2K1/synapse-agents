...
- Invoke the `synapse-advanced-elicitation` skill with the current inspiration analysis content
...
- Invoke the `synapse-party-mode` skill with the current inspiration analysis
...
- Read fully and follow: [Step 6: Design System Choice](./step-06-design-system.md)
...
After user selects 'C' and content is saved to document, load [Step 6: Design System Choice](./step-06-design-system.md) to choose the appropriate design system approach.
