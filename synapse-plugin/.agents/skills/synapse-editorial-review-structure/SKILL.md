---
name: synapse-editorial-review-structure
description: |-
  ...
  MANDATORY: Execute when reviewing and refining document structure, outline flow, content placement, and readability hierarchy.
  ...
  DO NOT trigger for:
    - Copy editing and spelling checks (prose-level).
    - Modifying actual code implementation.
---
...
**Applicability:** Synapse tasks, prompts, system instructions, XML definitions
