...
- Invoke the `synapse-advanced-elicitation` skill with the current user journey content
...
- Invoke the `synapse-party-mode` skill with the current user journeys
...
- Load [Step 11: Component Strategy](./step-11-component-strategy.md)
...
After user selects 'C' and content is saved to document, load [Step 11: Component Strategy](./step-11-component-strategy.md) to define component library strategy.
