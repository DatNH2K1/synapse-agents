---
name: synapse-tanstack
description: |-
  Best practices for TanStack Query and Router. Includes project initialization, query hooks, and routing patterns.

  MANDATORY: Execute when configuring or implementing TanStack Query, Router, Table, or other TanStack libraries in React/Solid/Vue/Svelte.
  ...
  DO NOT trigger for:
    ...
    - General non-TanStack styling libraries.
---
