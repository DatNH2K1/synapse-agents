...
<action>Read fully and follow [Discover Inputs Protocol](./discover-inputs.md) to load all input files</action>
...
<step n="6" goal="Update sprint status and finalize">
  <action>Validate the newly created story file {default_output_file} against [🎯 Story Context Quality Competition Prompt](./checklist.md) and apply any required fixes before finalizing</action>
...
<output>Report completion
    ...
    **Next Steps:**
    ...
    4. Optional: If Test Architect module installed, run `/synapse:tea:automate` after `dev-story` to generate guardrail tests
