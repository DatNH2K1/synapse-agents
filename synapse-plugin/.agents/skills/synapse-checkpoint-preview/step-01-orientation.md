...
## Follow Global Step Rules in [SKILL.md](./SKILL.md)
...
If review mode is not `full-trail`, read fully and follow [Generate Review Trail](./generate-trail.md) to build one from the diff. Then return here and continue to NEXT. If trail generation fails (e.g., git unavailable), the original review mode is preserved — step-02 handles this with its non-trail path.

## NEXT

Read fully and follow [Step 2: Walkthrough](./step-02-walkthrough.md)
