...
description: |-
  ...
  MANDATORY: Execute when indexing documentation for search, semantic retrieval, or knowledge base integration.

  Trigger immediately for:
    - index documentation
    - build doc index
    - markdown parser indexer
    - documentation search mapping

  DO NOT trigger for:
    - Writing new documentation.
    - Codebase indexing unrelated to user guides.
---
