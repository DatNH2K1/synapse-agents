...
- Invoke the `synapse-advanced-elicitation` skill with the current defining experience content
...
- Invoke the `synapse-party-mode` skill with the current defining experience
...
- Load [Step 8: Visual Foundation](./step-08-visual-foundation.md)
...
After user selects 'C' and content is saved to document, load [Step 8: Visual Foundation](./step-08-visual-foundation.md) to establish visual design foundation.
