...
```bash
python3 skills/synapse-design-suite/scripts/search.py "<product-type>" --domain product
python3 skills/synapse-design-suite/scripts/search.py "<style-keywords>" --domain style
python3 skills/synapse-design-suite/scripts/search.py "<mood>" --domain typography
python3 skills/synapse-design-suite/scripts/search.py "<industry>" --domain color
```
