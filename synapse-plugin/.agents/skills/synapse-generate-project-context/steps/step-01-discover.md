...
After user selects [C] to continue, load [Step 2: Context Rules Generation](./step-02-generate.md) to collaboratively generate the specific project context rules.
