...
- Invoke the `synapse-advanced-elicitation` skill with current starter analysis
...
- Invoke the `synapse-party-mode` skill with starter evaluation context
...
- Load [Step 4: Core Architectural Decisions](./step-04-decisions.md)
...
After user selects 'C' and content is saved to document, load [Step 4: Core Architectural Decisions](./step-04-decisions.md) to begin making specific architectural decisions.
