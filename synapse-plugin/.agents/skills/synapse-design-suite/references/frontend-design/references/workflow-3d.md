...
python3 skills/synapse-design-suite/scripts/search.py "immersive 3d" --domain style
python3 skills/synapse-design-suite/scripts/search.py "animation" --domain ux
```
