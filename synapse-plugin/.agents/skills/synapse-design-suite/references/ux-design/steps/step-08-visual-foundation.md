...
- Invoke the `synapse-advanced-elicitation` skill with the current visual foundation content
...
- Invoke the `synapse-party-mode` skill with the current visual foundation
...
- Load [Step 9: Design Direction Mockups](./step-09-design-directions.md)
...
After user selects 'C' and content is saved to document, load [Step 9: Design Direction Mockups](./step-09-design-directions.md) to generate design direction mockups.
