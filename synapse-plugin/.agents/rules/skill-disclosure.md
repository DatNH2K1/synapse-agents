...
- **Active Rules**: Rule files (e.g., `context-enforcement`, `subagent-delegation`, `execution-policy`, `system-policy`, `skill-disclosure`) whose constraints were actively applied.
...
- Example:
  ...
  ```
- CRITICAL: Do NOT group or merge these indicators into a single line. They must be output as three separate lines at the very end of the response.
