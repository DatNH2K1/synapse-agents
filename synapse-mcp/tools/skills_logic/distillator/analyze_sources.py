...
or glob patterns. Skips node_modules, .git, __pycache__, .venv, _synapse-output.
...
def analyze(inputs: list[str], output_path: str | None = None) -> None:
    ...
    # Split prediction
    estimated_distillate_tokens = (
        total_tokens // 3
    )  # rough: distillate is ~1/3 of source
