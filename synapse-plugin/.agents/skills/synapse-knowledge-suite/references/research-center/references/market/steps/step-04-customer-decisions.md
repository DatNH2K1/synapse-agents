...
- Load: [Market Research Step 5: Competitive Analysis](./step-05-competitive-analysis.md)
...
After user selects 'C', load [Market Research Step 5: Competitive Analysis](./step-05-competitive-analysis.md) to analyze competitive landscape, market positioning, and competitive strategies for {{research_topic}}.
