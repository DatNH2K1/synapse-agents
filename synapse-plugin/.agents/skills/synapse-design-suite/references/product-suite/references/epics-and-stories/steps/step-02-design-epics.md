...
- IF C: Save approved epics_list to {planning_artifacts}/epics.md, update frontmatter, then read fully and follow: [Step 3: Generate Epics and Stories](./step-03-create-stories.md)
...
ONLY WHEN C is selected and the approved epics_list is saved to document, will you then read fully and follow: [Step 3: Generate Epics and Stories](./step-03-create-stories.md) to begin story creation step.
