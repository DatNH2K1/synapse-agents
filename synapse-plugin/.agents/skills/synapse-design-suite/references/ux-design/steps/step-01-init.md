...
- **STOP here** and load [Step 1B: UX Design Workflow Continuation](./step-01b-continue.md) immediately
...
Copy the template from `.[Ux Design Template](./ux-design-template.md)` to `{planning_artifacts}/ux-design-specification.md`
...
After user selects [C] to continue, ensure the file `{planning_artifacts}/ux-design-specification.md` has been created and saved, and then load [Step 2: Project Understanding](./step-02-discovery.md) to begin the UX discovery phase.
