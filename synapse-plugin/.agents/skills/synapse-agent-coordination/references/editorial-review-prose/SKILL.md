...
description: |-
  ...
  MANDATORY: Execute when conducting copy editing, line editing, proofreading, and improving prose quality/tone.
  ...
  Trigger immediately for:
    ...
    - prose quality
    - tone adjustment
    - reviewing written text

  DO NOT trigger for:
    - Structural content analysis.
    - Formatting markdown tables/lists without text changes.
