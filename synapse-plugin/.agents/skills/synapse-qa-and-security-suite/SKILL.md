---
name: synapse-qa-and-security-suite
description: |
  Master Skill for testing, security audits, code reviews, and threat intelligence monitoring.

  MANDATORY: Activate when creating/running automated tests, conducting security scanning/pentesting, preparing pull request walkthroughs, or performing adversarial code reviews.
---

# Synapse QA and Security Suite

This Master Skill provides resources and specialized sub-skills for testing, code review, and cybersecurity workflows.
