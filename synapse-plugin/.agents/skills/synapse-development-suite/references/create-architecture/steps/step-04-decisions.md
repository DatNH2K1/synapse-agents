...
- Invoke the `synapse-advanced-elicitation` skill with specific decision categories
...
- Invoke the `synapse-party-mode` skill with architectural decisions context
...
- Load [Step 5: Implementation Patterns & Consistency Rules](./step-05-patterns.md)
...
After user selects 'C' and content is saved to document, load [Step 5: Implementation Patterns & Consistency Rules](./step-05-patterns.md) to define implementation patterns that ensure consistency across AI agents.
