...
nextStepFile: "[File references (ONLY variables used in this step)](./step-v-04-brief-coverage-validation.md)"
...
Validate PRD meets Synapse information density standards by scanning for conversational filler, wordy phrases, and redundant expressions that violate conciseness principles.
