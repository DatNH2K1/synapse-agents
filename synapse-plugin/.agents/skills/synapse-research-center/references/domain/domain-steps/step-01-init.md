...
- Load: [Domain Research Step 2: Industry Analysis](./step-02-domain-analysis.md)
...
After user selects 'C', load [Domain Research Step 2: Industry Analysis](./step-02-domain-analysis.md) to begin industry analysis.
