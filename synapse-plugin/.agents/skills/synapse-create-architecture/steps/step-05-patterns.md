...
- Invoke the `synapse-advanced-elicitation` skill with current patterns
...
- Invoke the `synapse-party-mode` skill with implementation patterns context
...
- Load [Step 6: Project Structure & Boundaries](./step-06-structure.md)
...
After user selects 'C' and content is saved to document, load [Step 6: Project Structure & Boundaries](./step-06-structure.md) to define the complete project structure.
