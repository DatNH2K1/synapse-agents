...
- IF C: Save all to {planning_artifacts}/epics.md, update frontmatter, then read fully and follow: [Step 2: Design Epic List](./step-02-design-epics.md)
- IF Any other comments or queries: help user respond then [Redisplay Menu Options](#10-present-menu-options)

## CRITICAL STEP COMPLETION NOTE

ONLY WHEN C is selected and all requirements are saved to document and frontmatter is updated, will you then read fully and follow: [Step 2: Design Epic List](./step-02-design-epics.md) to begin epic design step.
