...
- Invoke the `synapse-advanced-elicitation` skill with the current context analysis
...
- Invoke the `synapse-party-mode` skill with the current project context
...
- Load [Step 3: Starter Template Evaluation](./step-03-starter.md)
...
After user selects 'C' and content is saved to document, load [Step 3: Starter Template Evaluation](./step-03-starter.md) to evaluate starter template options.
