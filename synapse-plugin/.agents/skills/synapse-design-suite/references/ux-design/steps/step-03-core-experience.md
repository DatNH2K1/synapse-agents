...
- Invoke the `synapse-advanced-elicitation` skill with the current core experience content
...
- Invoke the `synapse-party-mode` skill with the current core experience definition
...
- Load [Step 4: Desired Emotional Response](./step-04-emotional-response.md)
...
After user selects 'C' and content is saved to document, load [Step 4: Desired Emotional Response](./step-04-emotional-response.md) to define desired emotional responses.
