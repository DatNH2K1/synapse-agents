...
- **STOP immediately** and load [Step 1B: Workflow Continuation](./step-01b-continue.md)
...
- IF C: Update output file frontmatter, adding this step name to the end of the list of stepsCompleted, then read fully and follow: [Step 2: Project Discovery](./step-02-discovery.md)
...
ONLY WHEN [C continue option] is selected and [frontmatter properly updated with this step added to stepsCompleted and documentCounts], will you then read fully and follow: [Step 2: Project Discovery](./step-02-discovery.md) to begin project discovery.
