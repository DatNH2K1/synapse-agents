...
After technique confirmation, load [Step 3: Interactive Technique Execution and Facilitation](./step-03-technique-execution.md) to begin facilitating the selected brainstorming techniques.
