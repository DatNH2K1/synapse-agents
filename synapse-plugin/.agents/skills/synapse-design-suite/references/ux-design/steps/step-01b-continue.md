...
- If `lastStep = 1` → Load [Step 2: Project Understanding](./step-02-discovery.md)
- If `lastStep = 2` → Load [Step 3: Core Experience Definition](./step-03-core-experience.md)
- If `lastStep = 3` → Load [Step 4: Desired Emotional Response](./step-04-emotional-response.md)
