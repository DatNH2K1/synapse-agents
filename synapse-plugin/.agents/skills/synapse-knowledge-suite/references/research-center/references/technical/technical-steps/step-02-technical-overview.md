...
- Load: [Technical Research Step 3: Integration Patterns](./step-03-integration-patterns.md)
...
After user selects 'C', load [Technical Research Step 3: Integration Patterns](./step-03-integration-patterns.md) to analyze APIs, communication protocols, and system interoperability for {{research_topic}}.
