...
- Invoke the `synapse-advanced-elicitation` skill with the current design direction content
...
- Invoke the `synapse-party-mode` skill with the current design direction
...
- Load [Step 10: User Journey Flows](./step-10-user-journeys.md)
...
After user selects 'C' and content is saved to document, load [Step 10: User Journey Flows](./step-10-user-journeys.md) to design user journey flows.
