...
- Invoke the `synapse-advanced-elicitation` skill with the current design system content
...
- Invoke the `synapse-party-mode` skill with the current design system choice
...
- Load [Step 7: Defining Core Experience](./step-07-defining-experience.md)
...
After user selects 'C' and content is saved to document, load [Step 7: Defining Core Experience](./step-07-defining-experience.md) to define the core user interaction.
