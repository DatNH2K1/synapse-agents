...
- Load: [Technical Research Step 4: Architectural Patterns](./step-04-architectural-patterns.md)
...
After user selects 'C', load [Technical Research Step 4: Architectural Patterns](./step-04-architectural-patterns.md) to analyze architectural patterns, design decisions, and system structures for {{research_topic}}.
