...
- Load: [Domain Research Step 3: Competitive Landscape](./step-03-competitive-landscape.md)
...
After user selects 'C', load [Domain Research Step 3: Competitive Landscape](./step-03-competitive-landscape.md) to analyze competitive landscape, key players, and ecosystem analysis for {{research_topic}}.
