...
- 🎯 Detect PRD format (Synapse/legacy)
...
This file defines what makes a great Synapse PRD. Internalize this understanding - it will guide improvement recommendations.
...
- Convert to Synapse format (if legacy PRD)
...
**Check for Synapse PRD core sections:**
...
- **Synapse Standard:** 5-6 core sections present
- **Synapse Variant:** 3-4 core sections present, generally follows Synapse patterns
- **Legacy (Non-Standard):** Fewer than 3 core sections, does not follow Synapse structure

### 8. Route Based on Format and Context

**IF validation report provided OR PRD is Synapse Standard/Variant:**
...
Read fully and follow: [File references (ONLY variables used in this step)](./step-e-02-review.md)
...
**[C] Convert to Synapse Format** - Convert PRD to Synapse standard structure, then apply your edits
...
- IF C (Convert): Read fully and follow: [File references (ONLY variables used in this step)](./step-e-01b-legacy-conversion.md)
...
- Synapse PRDs proceed directly to review step
