...
- Invoke the `synapse-advanced-elicitation` skill with the current component strategy content
...
- Invoke the `synapse-party-mode` skill with the current component strategy
...
- Load [Step 12: UX Consistency Patterns](./step-12-ux-patterns.md)
...
After user selects 'C' and content is saved to document, load [Step 12: UX Consistency Patterns](./step-12-ux-patterns.md) to define UX consistency patterns.
