...
- Synapse PRD standards: Load from prd-purpose.md

**Tasks:**

1. Read current PRD section
2. Apply specified changes
3. Ensure Synapse PRD principles compliance:
...
- Restructuring: Reformat content to Synapse standard
...
- Reorganize PRD to Synapse standard structure
- Ensure proper ## Level 2 headers
- Reorder sections logically
- Update PRD frontmatter to match Synapse format

**Follow Synapse PRD structure:**
...
Synapse standard structure applied.
