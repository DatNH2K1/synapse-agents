...
- **Load:** [Step 4: Idea Organization and Action Planning](./step-04-idea-organization.md)
...
- For option A: Invoke the `synapse-advanced-elicitation` skill
...
After technique completion and user confirmation, load [Step 4: Idea Organization and Action Planning](./step-04-idea-organization.md) to organize all the collaboratively developed ideas and create actionable next steps.
