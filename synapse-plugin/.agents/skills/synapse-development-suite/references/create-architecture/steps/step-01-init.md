...
- **STOP here** and load [Step 1b: Workflow Continuation Handler](./step-01b-continue.md) immediately
...
Copy the template from `.[Architecture Decision Template](./architecture-decision-template.md)` to `{planning_artifacts}/architecture.md`
...
After user selects [C] to continue, only after ensuring all the template output has been created, then load [Step 2: Project Context Analysis](./step-02-context.md) to analyze the project context and begin architectural decision making.
