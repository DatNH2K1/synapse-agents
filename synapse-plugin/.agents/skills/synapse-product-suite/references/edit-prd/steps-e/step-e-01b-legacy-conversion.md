...
Analyze legacy PRD against Synapse standards, identify gaps, propose conversion strategy, and let user choose how to proceed.
...
- ✅ You bring Synapse standards expertise and conversion guidance
...
- 🎯 Analyze legacy PRD against Synapse standard
...
**For each Synapse PRD section, analyze:**
...
- Manually check PRD for each Synapse section
...
**[R] Restructure to Synapse** - Full conversion to Synapse format, then apply your edits
...
- All 6 Synapse core sections analyzed for gaps
