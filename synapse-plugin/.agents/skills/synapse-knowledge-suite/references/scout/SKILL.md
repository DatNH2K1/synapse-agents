...
name: synapse-scout
description: |-
  Fast codebase scouting using parallel agents. Use for file discovery, task context gathering, quick searches across directories.

  MANDATORY: Execute when searching the web, analyzing external documentation, or exploring new APIs/libraries.

  Trigger immediately for:
    - external api research
    - search documentation web
    - scout new libraries
    - scraping technical blogs

  DO NOT trigger for:
    - Analyzing internal codebase files.
...
- `./references/task-management-scouting.md` - Task coordination patterns
