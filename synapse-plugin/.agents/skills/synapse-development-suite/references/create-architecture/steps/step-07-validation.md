...
- Invoke the `synapse-advanced-elicitation` skill with validation issues
...
- Invoke the `synapse-party-mode` skill with validation context
...
- Load [Step 8: Architecture Completion & Handoff](./step-08-complete.md)
...
After user selects 'C' and content is saved to document, load [Step 8: Architecture Completion & Handoff](./step-08-complete.md) to complete the workflow and provide implementation guidance.
