...
- Load: [Market Research Step 3: Customer Pain Points and Needs](./step-03-customer-pain-points.md)
...
After user selects 'C', load [Market Research Step 3: Customer Pain Points and Needs](./step-03-customer-pain-points.md) to analyze customer pain points, challenges, and unmet needs for {{research_topic}}.
