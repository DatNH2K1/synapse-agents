...
- The workflow framework will automatically:
  ...
  - Load workflow variables from [Create Story Workflow](./workflow.md)
...
1. **Load the workflow configuration**: [Create Story Workflow](./workflow.md) for variable inclusion
