...
- Invoke the `synapse-advanced-elicitation` skill with the current UX patterns content
...
- Invoke the `synapse-party-mode` skill with the current UX patterns
...
- Load [Step 13: Responsive Design & Accessibility](./step-13-responsive-accessibility.md)
...
After user selects 'C' and content is saved to document, load [Step 13: Responsive Design & Accessibility](./step-13-responsive-accessibility.md) to define responsive design and accessibility strategy.
